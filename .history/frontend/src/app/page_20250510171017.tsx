...
const WeatherIcon = ({ iconCode }: { iconCode: string }) => {
  switch (iconCode.slice(0, 2)) {
    case '01':
      return <Sun className="text-6xl text-yellow-400" />;
    case '02':
    case '03':
    case '04':
      return <Cloud className="text-6xl text-gray-400" />;
    case '09':
    case '10':
      return <CloudRain className="text-6xl text-blue-500" />;
    case '13':
      return <CloudSnow className="text-6xl text-white" />;
    case '50':
      return <CloudFog className="text-6xl text-gray-500" />;
    default:
      return <Cloud className="text-6xl text-gray-400" />;
  }
};
    ...
    try {
      ...
      setWeatherData({
        ...
        main: {
          ...
          feels_like: data.temperature, // Backend does not provide feels_like, using temperature as fallback
        ...
        weather: [
          {
            ...
            icon: '', // No icon from backend, can be enhanced later
          },
        ],
        wind: {
            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-gray-700 text-sm sm:text-base">
                ...
                <div className="flex items-center gap-2">
                  ...
                  Last updated: {format(new Date(weatherData.dt * 1000), 'MMM dd, HH:mm')}
                </div>
              </div>
            </CardContent>
          </Card>
